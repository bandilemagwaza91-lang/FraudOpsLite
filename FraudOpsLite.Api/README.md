...
1. A transaction is received via API
2. The transaction is stored in the database
3. Fraud rules are applied
4. If suspicious → an alert is generated
5. Alerts are stored and can be reviewed
...
4. Run migrations (Entity Framework)
